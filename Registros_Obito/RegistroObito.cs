...
{
    public partial class RegistroObito : Form
    {
        private int indexRow;

        public RegistroObito()
        {
            InitializeComponent();
            SelectTable();
        }
        ...
        private void SelectTable()
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(Conn.Strcon))
                {
                    ...
                    string sqlQuery = "SELECT  numPaciente, nomePaciente, dataEntrada, horaEntrada, dataSaida, horaSaida, CNS, clinicaNome, localizacaoInterna, leito, centroCusto, hipoteseDiagnostico, medicoResponsavel, CRM, diagnostico, situacao FROM registroObito";
